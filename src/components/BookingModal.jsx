      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            value={user.email}
            readOnly
            className="w-full px-4 py-2 border rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 cursor-not-allowed"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="bg-white dark:bg-gray-800 w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500"
            required
        ...
        <div className="flex justify-end space-x-4 mt-6">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-3 bg-red-600 hover:bg-red-700 text-gray-800 rounded-lg transition font-medium"
          >
            Cancel
          </button>
          <button
